...
describe("Database Tests", function() {
    ...
    before(function() {
    var db = require("../db/db", function(res){
        console.log('waiting for the callback', db)
    });
    ...
    it("It should Post the comments successfully", done => {
        ...
        .end((err, res) => {
            ...
            .property("message")
            .eql("The comment has been successfully posted.");
            done();
        });
    });
    });
    ...
    it("It should Fetch the comments successfully", done => {
        ...
        .end((err, res) => {
            ...
            res.body.should.have
            .property("message")
            .eql("The comments have been fetched.");
    ...
    it("It should Delete all the comments of test_org successfully", done => {
        ...
        .end((err, res) => {
            ...
            res.body.should.have
            .property("message")
            .eql("The comments have been soft deleted.");
            done();
        });
    });
    });
    ...
    it("It should Get all members of the org successfully", done => {
        ...
        .end((err, res) => {
            ...
            res.body.should.have
            .property("message")
            .eql("Members have been successfully fetched.");
            done();
        });
    });
    });
